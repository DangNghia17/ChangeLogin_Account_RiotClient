...
public class AccountDialog extends JDialog {
    ...
    public AccountDialog(JFrame parent, Account account) {
        super(parent, account == null
                ? LanguageManager.getString("account.add.title")
                : LanguageManager.getString("account.edit.title"), true);
    ...
    private void initializeUI(Account account) {
        ...
        regionCombo.setSelectedItem(account != null ? account.getRegion() : "VN");
