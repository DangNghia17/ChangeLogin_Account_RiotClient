...
/** "About" dialog with collapsible informational sections. */
public class AboutDialog extends JDialog {
    ...
    private void initializeUI() {
        ...
        for (int i = 1; i <= 5; i++) {
            addNumberedSection(contentPanel, i,
                    LanguageManager.getString("about.section" + i + ".title"),
                    LanguageManager.getString("about.section" + i + ".content"));
        }
        ...
        JLabel versionLabel = new JLabel("Version 2.0.0 | MIT License");
        ...
        JButton showWelcomeButton = UIHelper.createMaterialButton(
                LanguageManager.getString("about.showWelcome"), new Color(100, 100, 100));
        ...
        JButton closeButton = UIHelper.createMaterialButton(
                LanguageManager.getString("about.close"), UITheme.PRIMARY_COLOR);
